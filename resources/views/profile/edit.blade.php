                ...
                <div class="card card-profile shadow">
                    <div class="row justify-content-center">
                        <div class="col-lg-3 order-lg-2">
                            <div class="card-profile-image">
                                <a href="#">
                                    <img src="{{ asset('bower_components/demo_template/argon') }}/img/theme/team-4-800x800.jpg" class="rounded-circle">
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body pt-0 pt-md-4">
                        ...
                        <div class="text-center">
                            <h3>
                               {{ $user->last_name }}<span class="font-weight-light">, 27</span>
                            </h3>
                        ...
                        <form method="post" action="{{ route('users.update', ['user' => $user->id]) }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="alert alert-success">
                                      <p>{{ __(session('success_user')) }}</p>
                                </div>
                                @endif
                                <div class="form-group{{ $errors->has('first_name') ? ' has-danger' : '' }}">
                                    <label class="form-control-label" for="input-name">{{ __('First name') }}</label>
                                    <input type="text" name="first_name" id="input-name" class="form-control form-control-alternative{{ $errors->has('first_name') ? ' is-invalid' : '' }}" placeholder="{{ __('First name') }}" value="{{ old('first_name', $user->first_name) }}" required autofocus>
                                    ...
                                    <div class="form-group{{ $errors->has('last_name') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="last_name" id="input-lastname" class="form-control form-control-alternative{{ $errors->has('last_name') ? ' is-invalid' : '' }}" placeholder="{{ __('Last name') }}" value="{{ old('last_name', $user->last_name) }}" required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('username') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="username" id="input-username" class="form-control form-control-alternative{{ $errors->has('username') ? ' is-invalid' : '' }}" placeholder="{{ __('Username') }}" value="{{ old('username', $user->username) }}" required>
