            ...
            <div class="card shadow">
                ...
                <div class="table-responsive">
                    <table class="table align-items-center table-flush">
                        ...
                        <tbody>
                                                                <tr>
                                    <td><a href="{{ route('users.show', ['user' => 1]) }}">Admin Admin</a></td>
                                    <td>
                                    ...
                                    <td class="text-right">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                <a class="dropdown-item" href="{{ route('users.show', ['user' => 1]) }}">Detail</a>
                                                <a class="dropdown-item" href="{{ route('users.edit', ['user' => 1]) }}">Edit</a>
                                                <a class="dropdown-item" href="{{ route('users.destroy', ['user' => 1]) }}">Delete</a>
                                                                                                </div>
                                        </div>
                                    </td>
                                </tr>
